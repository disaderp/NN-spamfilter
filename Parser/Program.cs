...
namespace Parser
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string fileName = "0092.bf7453c6b7917ca30074a3030d84e36d";
            string filePath = Path.GetDirectoryName(Path.GetDirectoryName(System.IO.Directory.GetCurrentDirectory())) + @"\EMAILS\spam\" + fileName;
            string filePath1 = Path.GetDirectoryName(Path.GetDirectoryName(System.IO.Directory.GetCurrentDirectory())) + @"\EMAILS\spam\";
